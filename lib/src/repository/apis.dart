...
import 'package:chatgoogle/src/config/constants.dart';
import 'package:chatgoogle/src/models/config/gemini_safety_settings.dart';
import 'package:chatgoogle/src/models/config/gemini_config.dart';
import 'package:chatgoogle/src/models/gemini/gemini_response.dart';
...
Future<GeminiHttpResponse> apiGenerateText(
  ...
  var url = Uri.https(Constants.endpoit, 'v1beta/models/$model:generateContent',
      {'key': "AIzaSyAQ7wKFUAt7JE7mpEhXEApW0PIYCW2iBKI"});
